...
use App\Http\Middleware\InvoiceWithGateway;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'role-authenticator'    =>  RoleAuthenticator::class,
        'is_customer_verified' => IsVerifiedMiddleware::class,
        'document_verified' => VerifyDocument::class,
        'check_gateways_status' =>  InvoiceWithGateway::class
    ];
}
