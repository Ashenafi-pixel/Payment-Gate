...
<div class="row g-4 mb-5">
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="d-box  ">
            ...
            <h3 class="d-heading ">
                ...
                data-purecounter-end="{{$totalMerchantsCount}}"
                class="purecounter"
                >{{ $totalMerchantsCount }}</span>
            </h3>
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="d-box  ">
            ...
            <h3 class="d-heading ">
                <span
                data-purecounter-duration="2.5"
                data-purecounter-end="{{ $activeMerchantsCount }}"
                class="purecounter"
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="d-box  ">
            ...
            <h3 class="d-heading ">
                <span
                data-purecounter-duration="2.5"
                data-purecounter-end="{{ $pendingMerchantsCount }}"
                class="purecounter"
                >{{ $pendingMerchantsCount }}</span>
            </h3>
            <img width="34" class='img-loader' src="{{asset('images/loader.gif')}}" alt="">
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="d-box  ">
            ...
            <h3 class="d-heading ">
                <span
                data-purecounter-duration="2.5"
                data-purecounter-end="{{ $rejectedMerchantsCount }}"
                class="purecounter"
                >{{ $rejectedMerchantsCount }}</span>
            </h3>
            <img width="34" class='img-loader' src="{{asset('images/loader.gif')}}" alt="">
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="d-box  ">
            ...
            <h3 class="d-heading ">
                <span
                data-purecounter-duration="2.5"
                data-purecounter-end="{{ $totalCustomersCount }}"
                class="purecounter"
                >{{ $totalCustomersCount }}</span>
            </h3>
            <img width="34" class='img-loader' src="{{asset('images/loader.gif')}}" alt="">
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="d-box  ">
            <div class="text-end mb-2">
                <img height="30" class="filter" src="{{asset('images/icons/d-total-invoices.svg')}}" alt="">
            </div>
            <h3 class="d-heading ">     <span
                data-purecounter-duration="2.5"
                data-purecounter-end="{{ $totalInvoicesCount }}"
                class="purecounter"
                >{{ $totalInvoicesCount }}</span></h3>
            <img width="34" class='img-loader' src="{{asset('images/loader.gif')}}" alt="">
        ...
        <div class="flex-mode justify-content-between mb-3">
            ...
            <div class="d-flex gap-2">
                    <select name="transaction_day" id="" class="chart-select transaction">
                        ...
                        @for($i=1;$i <= 31;$i++)
                            <option value="{{$i}}" {{ request()->transaction_day == $i ? 'selected':'' }}>{{str_pad($i,2,'0',STR_PAD_LEFT)}}</option>
                        @endfor
                    </select>
                    <select name="transaction_month" id="" class="chart-select transaction">
                        <option value="">Month</option>
                        <option value="Jan" {{ request()->transaction_month == 'Jan' ? 'selected':'' }}>Jan</option>
                        <option value="Feb" {{ request()->transaction_month == 'Feb' ? 'selected':'' }}>Feb</option>
                        <option value="Mar" {{ request()->transaction_month == 'Mar' ? 'selected':'' }}>Mar</option>
                        <option value="Apr" {{ request()->transaction_month == 'Apr' ? 'selected':'' }}>Apr</option>
                        <option value="May" {{ request()->transaction_month == 'May' ? 'selected':'' }}>May</option>
                        <option value="Jun" {{ request()->transaction_month == 'Jun' ? 'selected':'' }}>Jun</option>
                        <option value="Jul" {{ request()->transaction_month == 'Jul' ? 'selected':'' }}>Jul</option>
                        <option value="Aug" {{ request()->transaction_month == 'Aug' ? 'selected':'' }}>Aug</option>
                        <option value="Sep" {{ request()->transaction_month == 'Sep' ? 'selected':'' }}>Sep</option>
                        <option value="Oct" {{ request()->transaction_month == 'Oct' ? 'selected':'' }}>Oct</option>
                        <option value="Nov" {{ request()->transaction_month == 'Nov' ? 'selected':'' }}>Nov</option>
                        <option value="Dec" {{ request()->transaction_month == 'Dec' ? 'selected':'' }}>Dec</option>
                    </select>
                    <select name="transaction_year" id="" class="chart-select transaction">
                        <option value="">Year</option>
                        <option value="2023" {{ request()->transaction_year == '2023' ? 'selected':'' }}>2023</option>
                        <option value="2022" {{ request()->transaction_year == '2022' ? 'selected':'' }}>2022</option>
                        <option value="2021" {{ request()->transaction_year == '2021' ? 'selected':'' }}>2021</option>
                    </select>
            </div>
        </div>
        <div class="d-box chart-height">
        ...
        <div class="flex-mode justify-content-between mb-3">
            ...
            <div class="d-flex gap-2">
                    <select name="payment_method_day" id="" class="chart-select transaction">
                        <option value="">00</option>
                        @for($i=1;$i <= 31;$i++)
                            <option value="{{$i}}" {{ request()->payment_method_day == $i ? 'selected':'' }}>{{str_pad($i,2,'0',STR_PAD_LEFT)}}</option>
                        @endfor
                    </select>
                    <select name="payment_method_month" id="" class="chart-select transaction">
                        <option value="">Month</option>
                        <option value="Jan" {{ request()->payment_method_month == 'Jan' ? 'selected':'' }}>Jan</option>
                        <option value="Feb" {{ request()->payment_method_month == 'Feb' ? 'selected':'' }}>Feb</option>
                        <option value="Mar" {{ request()->payment_method_month == 'Mar' ? 'selected':'' }}>Mar</option>
                        <option value="Apr" {{ request()->payment_method_month == 'Apr' ? 'selected':'' }}>Apr</option>
                        <option value="May" {{ request()->payment_method_month == 'May' ? 'selected':'' }}>May</option>
                        <option value="Jun" {{ request()->payment_method_month == 'Jun' ? 'selected':'' }}>Jun</option>
                        <option value="Jul" {{ request()->payment_method_month == 'Jul' ? 'selected':'' }}>Jul</option>
                        <option value="Aug" {{ request()->payment_method_month == 'Aug' ? 'selected':'' }}>Aug</option>
                        <option value="Sep" {{ request()->payment_method_month == 'Sep' ? 'selected':'' }}>Sep</option>
                        <option value="Oct" {{ request()->payment_method_month == 'Oct' ? 'selected':'' }}>Oct</option>
                        <option value="Nov" {{ request()->payment_method_month == 'Nov' ? 'selected':'' }}>Nov</option>
                        <option value="Dec" {{ request()->payment_method_month == 'Dec' ? 'selected':'' }}>Dec</option>
                    </select>
                    <select name="payment_method_year" id="" class="chart-select transaction">
                        <option value="">Year</option>
                        <option value="2023" {{ request()->payment_method_year == '2023' ? 'selected':'' }}>2023</option>
                        <option value="2022" {{ request()->payment_method_year == '2022' ? 'selected':'' }}>2022</option>
                        <option value="2021" {{ request()->payment_method_year == '2021' ? 'selected':'' }}>2021</option>
                    </select>
