        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="d-box  ">
                    ...
                    <h3 class="d-heading ">
                        <span data-purecounter-duration="2.5" data-purecounter-end="{{ $customersCount }}"
                            class="purecounter">{{ $customersCount }}</span>
                    </h3>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="d-box  ">
                    ...
                    <h3 class="d-heading "> <span data-purecounter-duration="2.5"
                            data-purecounter-end="{{ $invoicesCount }}" class="purecounter">{{ $invoicesCount }}</span></h3>
                    <img width="34" class='img-loader' src="{{ asset('images/loader.gif') }}" alt="">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="d-box  ">
                    ...
                    <p class="d-text ">Pending Transactions</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="d-box  ">
                    ...
                    <img width="34" class='img-loader' src="{{ asset('images/loader.gif') }}" alt="">
                    <h3 class="d-heading "> <span data-purecounter-duration="2.5"
                            data-purecounter-end="{{ $paidInvoicesCount }}"
                            class="purecounter">{{ $paidInvoicesCount }}</span></h3>
                    <p class="d-text ">Paid Transactions</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="d-box  ">
                    ...
                    <img width="34" class='img-loader' src="{{ asset('images/loader.gif') }}" alt="">
                    <h3 class="d-heading ">ብር.<span data-purecounter-duration="2.5"
                            data-purecounter-end="{{ $pendingBalanceSum }}"
                            class="purecounter">{{ $pendingBalanceSum }}</span></h3>
                    <p class="d-text ">Pending Balance</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="d-box  ">
                    ...
                    <img width="34" class='img-loader' src="{{ asset('images/loader.gif') }}" alt="">
                    <h3 class="d-heading ">ብር.<span data-purecounter-duration="1"
                            data-purecounter-end="{{ $availableBalanceSum }}"
                            class="purecounter">{{ $availableBalanceSum }}</span></h3>
                    <p class="d-text ">Available Balance</p>
                </div>
            </div>
            <!---Invoice Chart------->
            <div class="col-12">
