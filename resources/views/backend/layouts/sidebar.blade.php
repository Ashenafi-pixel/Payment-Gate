    ...
    <ul class="nav d-flex flex-column">
        ...
        @role(\App\Helpers\IUserRole::MERCHANT_ROLE)
            ...
            @if (\App\Helpers\GeneralHelper::USER()->is_school == true)
                <li class="nav-item">
                    <a class="nav-link s-links"
                        href="{{ route(\App\Helpers\IUserRole::MERCHANT_ROLE . '.students.index') }}">
                        <img width='18' src="{{ asset('images/icons/customers.svg') }}" alt="">
        ...
        @role(\App\Helpers\IUserRole::ADMIN_ROLE)
            <li class="nav-item position-relative" id="merchant-link">
                <a class="nav-link s-links collapsed {{ Request::is('admin/customers*') ? 'active' : '' }} "
                    href="#customers" aria-expanded="true" aria-current="page" data-bs-toggle="collapse"
                    aria-controls="merchant">
                    <img width='18' src="{{ asset('images/icons/customers.svg') }}" alt="">
                    <span>{{ __('Customers') }}</span>
                </a>
        ...
        @role(\App\Helpers\IUserRole::ADMIN_ROLE)
            <li class="nav-item position-relative" id="approval-link">
                <a class="nav-link s-links collapsed {{ Request::is('admin/pending*') ? 'active' : '' }} "
                    href="#approval" aria-expanded="true" aria-current="page" data-bs-toggle="collapse"
        ...
        @role(\App\Helpers\IUserRole::ADMIN_ROLE)
            <li class="nav-item position-relative" id="approval-link">
                <a class="nav-link s-links collapsed {{ Request::is('admin/gateways*') ? 'active' : '' }} "
                    href="#gateway" aria-expanded="true" aria-current="page" data-bs-toggle="collapse"
                    aria-controls="approval">
                    <img width='18' src="{{ asset('images/icons/gateways.svg') }}" alt="">
                    <span>{{ __('Gateways') }}</span>
                </a>
        ...
        @role(\App\Helpers\IUserRole::ADMIN_ROLE)
            <li class="nav-item">
                <a class="nav-link s-links collapsed" href="#merchant-fee" aria-expanded="true"
        ...
        @if (Auth::user()->hasAnyPermission(['reports_read', 'reports_delete']))
            <li class="nav-item">
                <a class="nav-link s-links collapsed" href="#reports" aria-expanded="true"
                    data-bs-toggle="collapse">
        ...
        @role(\App\Helpers\IUserRole::ADMIN_ROLE)
            ...
            <li class="nav-item">
                <a class="nav-link s-links {{ Request::is('admin/customer-ledgers') ? 'active' : '' }}"
                    href="{{ route('admin.ledgers.customer') }}">
                    <img width='18' src="{{ asset('images/icons/ledger.svg') }}" alt="">
