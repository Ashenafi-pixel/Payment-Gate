    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="credential-holder">
                <div class="row">
                    <div class="col-12">
                        <div class="login-content text-center text-white" data-aos="fade-up" data-aos-easing="linear"
                            data-aos-duration="1500">
                            <h3 class="sub-heading">
                                {!! __('Account Verification') !!}
                            </h3>
                            <p class="b-text mb-0 text-center">
                                {!! __('We have sent a verification code to your mobile
                                ******'.substr(\App\Helpers\GeneralHelper::USER('mobile_number'),-6)) !!}
                            </p>
                        </div>
                    </div>
                    <div class="col-12 text-center">
                        <div class="container my-5">
                            {!! Form::open(['url' => route(App\Helpers\IUserRole::MERCHANT_ROLE.'.profile.verify.otp'),
                            ...
                            <div class="row">
                                <div class="col-lg-9 my-auto justify-content-center justify-content-lg-start d-flex ">
                                    ...
                                    {!! Form::open(['url' =>
                                    route(\App\Helpers\IUserRole::CUSTOMER_ROLE.'.profile.resend.otp'),'id'=>'resend_form','class'
                                    => 'ajax d-none']) !!}
